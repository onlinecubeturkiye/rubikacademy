// CLL diagram generator for 2x2 (Restored proper 12-element layout and swapped red/orange).
function cllSvg(pattern, mode, size) {
var Y = "#f6c719", GRAY = "#4b515c";
// Kırmızı ve turuncunun yer değiştirdiği renk paleti
...
// 2. 4 surrounding side strips (8 elements total matching pattern strings)
